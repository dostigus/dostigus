...
**Next number = max + 1.** The highest file is ADR 0027, so the next ADR
is **0028**. Name it `0028-short-kebab-title.md` (four digits). When you
...
| [0004](0004-llm-gateway-tiers.md) | LLM gateway and model tiers |
