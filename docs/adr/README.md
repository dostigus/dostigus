...
**Next number = max + 1.** The highest file is ADR 0030, so the next ADR
is **0031**. Name it `0031-short-kebab-title.md` (four digits). When you
...
| [0030](0030-chat-cards-module-catalog.md) | Chat Cards for Schedule, Skill, and self-settings changes (amended 2026-09-24: no stock Module packages, no Weather seed; meta Skills insert-if-missing on Bot create) |
