...
export const BOT_MARKS: Record<BotAvatarShape, BotMark> = {
  ...
  parrot: {
    ...
    crest: [
      { tag: 'path', d: 'M33.5 15 C30 10 26 6.5 22.5 4.5 C25 9.5 26.5 13 28 17.5 Z' },
      { tag: 'path', d: 'M38.5 12 C36.5 6.5 34 2.5 31.5 0 C32.5 5.5 33 9.5 33.5 14 Z' },
      { tag: 'path', d: 'M43.5 11.5 C43 6 41.5 2 40 -0.5 C40 5 39.5 8.5 39.5 12.5 Z' },
    ],
