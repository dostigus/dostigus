...
it('splits Settings into Провайдеры and Прочее with a left nav', () => {
  ...
  expect(shell).toContain('Провайдеры')
  expect(shell).toContain('Прочее')
  ...
  expect(other).toContain('Cluster timezone')
  expect(other).toContain('Cluster http allowlist')
...
it('leads Провайдеры with Bots ↔ Providers, key-first OpenRouter, shelf, and health', () => {
  ...
  expect(providers).toContain('Подробнее')
  expect(providers).toContain('/catalog')
  expect(providers).not.toContain('apiKey: provider.apiKey')
  expect(flow).toContain('Bots думают через LLM')
  expect(add).toContain('Подключите OpenRouter')
  expect(add).toContain('openai-compatible')
  expect(add).toContain('LLM_PROVIDER_KIND_LABELS')
  expect(shelf).toContain('Оставить маршрутизацию OpenRouter')
  expect(shelf).toContain('OPENROUTER_SHELF_LABELS')
  expect(shelf).toContain('Vision')
  expect(advanced).toContain('Все модели')
  expect(advanced).toContain('Обновить список')
