...
it('uses the Kit mark, sticker, Dialog, and Sheet on the Host', () => {
  ...
  expect(sidebar.indexOf('class="list"')).toBeLessThan(sidebar.indexOf('class="side-head"'))
  expect(sidebar.indexOf('class="side-head"')).toBeLessThan(sidebar.indexOf('<HostUserMenu'))
